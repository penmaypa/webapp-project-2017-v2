...
<html>
	<head>
		<title>Giggs2Go in Birmingham</title>
	...
	<div class="navbar-fixed-top navbar-inverse" id="home">
			  ...
			  <div class="container-fluid">
			    <div class="navbar-header">
			      <a class="navbar-brand" href="home.html">Giggs2Go</a>
			    </div>
	...
	<div class="jumbotron6">
		...
		<div class="container" id="artist">
			<div class="col-md-6">
				<h1>Upcoming Events In Birmingham</h1>
			</<div>
		</div>
		</div>
	...
	<div class="row padding" id="about">
			<div class="container">
				...
				<!-- $json = file_get_contents("https://app.ticketmaster.com/discovery/v2/events.json?apikey=EAMfG9ADdU4rCwmYkGGXxsG6ld8qx8p8&city=birmingham&countryCode=GB&classificationName=music"); -->
