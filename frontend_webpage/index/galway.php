...
<html>
	<head>
		<title>Giggs2Go in Galway</title>
	...
	<div class="jumbotron1">
		...
		<div class="container" id="artist">
			<div class="col-md-6">
				<h1>Upcoming Events In Galway</h1>
			</<div>
		</div>
		</div>
	...
	<div class="row padding" id="about">
			<div class="container">
				...
				<!-- $json = file_get_contents("https://app.ticketmaster.com/discovery/v2/events.json?apikey=EAMfG9ADdU4rCwmYkGGXxsG6ld8qx8p8&city=galway&countryCode=IE&classificationName=music"); -->
