...
<html>
	<head>
		<title>Giggs2Go in Manchester</title>
	...
	<div class="jumbotron5">
		...
		<div class="container" id="artist">
			<div class="col-md-6">
				<h1>Upcoming Events In Manchester</h1>
			</<div>
		</div>
		</div>
	...
	<div class="row padding" id="about">
			<div class="container">
				...
				<!-- $json = file_get_contents("https://app.ticketmaster.com/discovery/v2/events.json?apikey=EAMfG9ADdU4rCwmYkGGXxsG6ld8qx8p8&city=manchester&countryCode=GB&classificationName=music"); -->
