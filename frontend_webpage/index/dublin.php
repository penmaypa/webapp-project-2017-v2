...
<html>
	...
	<body>
	<!-- I got the code for the navbar from (https://www.w3schools.com/bootstrap/bootstrap_navbar.asp) it is used in almost all webpages -->
			...
			<div class="container">
				...
				<p style="font-size:18px;">	
					...
					<?php 
						...
						// I got the API link from (https://developer.ticketmaster.com/api-explorer/) this line is used many times in all webpages its 
						$json = file_get_contents("https://app.ticketmaster.com/discovery/v2/events.json?apikey=EAMfG9ADdU4rCwmYkGGXxsG6ld8qx8p8&city=dublin&countryCode=IE&classificationName=music");
